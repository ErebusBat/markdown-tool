...
func TestGetWriters(t *testing.T) {
	...
	if len(writers) != 6 {
		t.Errorf("Expected 6 writers, got %v", len(writers))
	}

	expectedNames := []string{"URLWriter", "JIRAKeyWithDescriptionWriter", "JIRAWriter", "PhoneWriter", "RaycastWriter", "PassthroughWriter"}
